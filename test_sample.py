...
try:
    ...
    print("Your preferred data is now available in Output_excel.xlsx file "+"\U0001F642")
except ValueError:
    print("sorry,no such ps number exist")
except KeyError:
    print("wrong data")
""" Pytest starts here tests timing conversion of convert24 function
"""
class TestTransformationEngine(unittest.TestCase):
    def test_finding(self):
        output = finding(99004324)
        self.assertEqual(True, output>=0)
    def test_check(self):
        output=checking("Hobbies")
        self.assertEqual(80, output)
    def test_check1(self):
        output = checking("cat")
        self.assertEqual('sorry', output)
